...
const sectionMostrador2 = document.querySelector('[meta-mostrador-consolas]');
const sectionMostrador3 = document.querySelector('[meta-mostrador-diversos]');
...
conexionesServidor.productosDisponibles().then((data) => {
    ...
    data.forEach((perfil) => {
        ...
        else if (perfil.categoria == 'consolas'){

            sectionMostrador2.appendChild(nuevoProducto);

        }

        else{

            sectionMostrador3.appendChild(nuevoProducto);
